...
# choose
from .resnet_adaptive import BasicBlock, Bottleneck, get_expansion, AdaptBlock  # from DEKR
from .dcn_adaptive import BasicBlock, Bottleneck, get_expansion, AdaptBlock  # from DEKR
# from .resnet_mmdet import BasicBlock, Bottleneck, get_expansion
# from .dcn import BasicBlock, Bottleneck, get_expansion
# from .nam import BasicBlock, Bottleneck, get_expansion
...
class HRModule(nn.Module):
    ...
    def __init__(self,
                 ...
                 in_channels,
                 num_channels,
                 multiscale_output=True,  # conv_modeule
                 with_cp=False,
                 conv_cfg=None,
